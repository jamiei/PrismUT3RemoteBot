...
uses
  ...
  System.Text;
type
  BotMesh = public enum(    IronGuard = -1,
    Lauren = 0,
    Barktooth,
    Reaper,
    Sharptooth,
    Harbinger,
    Matrix);  BotColor = public enum(    Random = -2,
    None = -1,
    Red = 0,
    Blue = 1);  Emote = public enum(    [StringValue('TauntA')]
    /// <summary>
    ...
    SlitThroat);  FireType = public enum(    None = 0,
    Firing = 1,
    AltFiring = 2);  ItemType = public enum(    None = 0,
    Weapon,
    Ammo,
    Health,
    Armor);  WeaponType = public enum(    [StringValue('')]
    None = 0,
    ...
    InstaGibRifle);  AmmoType = public enum(    [StringValue('')]
    None = 0,
    ...
    InstaGibRifle);  HealthType = public enum(    [StringValue('')]
    None = 0,
    ...
    SuperHealth);  ArmorType = public enum(    [StringValue('')]
    None = 0,
